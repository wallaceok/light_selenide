...
//	}
	...
	public void aCreateBusinessTest() {
		...
		TradingAreaPage tradingAreaPage = open("http://app-member.fx.com/dictionary/business",TradingAreaPage.class);
		
		tradingAreaPage.addBusiness();
		
		tradingAreaPage.searchBusiness();
		
		tradingAreaPage.audtingClick();
		
		tradingAreaPage.noAudtingClick();
		
		tradingAreaPage.editBusiness();
		
		tradingAreaPage.delete();
